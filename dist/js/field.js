...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-select-options', __webpack_require__(3));
    Vue.component('detail-select-options', __webpack_require__(6));
    Vue.component('form-select-options', __webpack_require__(9));
});
